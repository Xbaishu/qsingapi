...
if [ -z "$qua" ]; then
  ...
  exit
    ...
    response=$(curl --max-time 60 -X POST -H "Content-Type: application/x-www-form-urlencoded" --data "uin=114514&qua="$qua"&cmd=sign&seq=1848698645&buffer=0C099F0C099F0C099F&guid=123456&android_id=114514" $URL)
